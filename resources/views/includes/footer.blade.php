        <div class="page-footer">
            <div class="page-footer-inner"> 2016 &copy; prodconx.
            </div>
...
<![endif]-->
        ...
        <script src="{{ URL::asset('assets/global/plugins/horizontal-timeline/horozontal-timeline.min.js')}}" type="text/javascript"></script>
       ...
       <!-- <script src="{{ URL::asset('assets/global/plugins/jquery-validation/js/jquery.validate.min.js')}}" type="text/javascript"></script> -->
		...
		<script src="{{ URL::asset('assets/my_custom.js')}}" type="text/javascript"></script>	
		...
		<script>
				...
				if(active_class =='Settings' || active_class =='imageSettings' || active_class =='mailSettings' || active_class == 'socialSettings'){					
					$( '.my-setting' ).addClass( "open active" );
					$('.inner-setting').css('display','block');
				}
