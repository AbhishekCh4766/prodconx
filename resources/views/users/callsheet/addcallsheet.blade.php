    ...
    <div class="post-page main-page">
			...
			<div class="container">
				<div class="profile-part">
					...
					<form class="addCallsheet-bx-form" action="{{ URL::to('/addcallsheetdata')}}" method="POST" name="add_project_form" >
					<h3><span>1.</span> Enter Details</h3>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="callsheet_title" id="name"  placeholder="Call Sheet Title…" required />
									{{csrf_field()}}
						...
						<div class="form-group cols-sm-6">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="date" data-toggle="datepicker" class="form-control" name="callsheet_date" id="datepicker"  placeholder="Sat, Aug 19, 2017" required />
								</div>
							</div>
						</div>
						...
						<div class="form-group cols-sm-6 rightside">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="time" class="form-control timepicker" name="callsheet_time" id="time"  placeholder="7:00am" required />
								</div>
							</div>
						</div>
						<div class="form-group cols-sm-6">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-file-text" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="director_name" id="director_name"  placeholder="Enter Name" required />
								</div>
							</div>
						</div>
						...
						<div class="form-group cols-sm-6">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-file-text" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="producer_name" id="producer_name"  placeholder="Enter Name" required />
								</div>
							</div>
						</div>
						...
						<div class="form-group cols-sm-6">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-phone" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="producer_phone" id="producer_phone"  placeholder="Enter Phone No." required />
								</div>
							</div>
						</div>
						...
						<div class="form-group cols-sm-6">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-file-text" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="adirector_name" id="adirector_name"  placeholder="Enter Name" required />
								</div>
							</div>
						</div>
						...
						<div class="form-group cols-sm-6">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-phone" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="adirectorphone" id="adirectorphone"  placeholder="Enter Phone No." required />
								</div>
							</div>
						</div>
						...
						<div class="form-group ">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-file-text" aria-hidden="true"></i></span>
									 <textarea class="form-control" rows="3"   name="location" id="exampleTextarea"  placeholder="Enter Address" required></textarea>
...
<div class="select-type-bx">
	...
	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 chooseType" id="shootday">
		<div class="select-type-inr active">
	...
	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 chooseType" id="meeting">
		<div class="select-type-inr">
			...
			<div class="select-type-bx bottom-bx">
					...
					<div class="next">
					<input type="hidden" class="call_type" value="shootday" name="call_type">
