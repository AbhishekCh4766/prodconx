				...
				<div class="profile-part">
					...
					<div class="addCallsheet-bx">
						<?php 
									 ...
									 $id =  App\Models\Callsheet_Location::where('callsheet_id', $callsheet_id)->pluck('id');
                                     
									 ?>
		           			<form action="{{URL::to('/updatelocationCall')}}" method="POST" >
				<div class="profile-part">
					<div class="row">
										...
										<tr>
											<td style="width: 4.1%; width:50px;">
												<div class="checkbox radio-margin">
													<label>
                                                     @if( in_array($location->id, $exploded_array) ) 
                                          	           <input type="checkbox" value="{{$location->id}}" name="project_location[]" checked>
										                @else
