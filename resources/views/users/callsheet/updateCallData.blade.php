...
<!-- top-bar -->
  	<div class="post-page main-page">
		...
		<div class="mid-page addCallsheet-main">
			<div class="container">
				<form action="{{URL::to('/updateContactCallsheet')}}" method="POST" >
					<div class="profile-part">
						...
						<div class="tab">
						  <a style="cursor:pointer;" class="tablinks" onclick="openCity(event, 'London')"> <i class="fa fa-users" aria-hidden="true"></i> My Contacts</a><br/><br/>
						  <a style="cursor:pointer;" class="tablinks" onclick="openCity(event, 'Paris')"> <i class="fa fa-user" aria-hidden="true"></i> Crew</a><br/><br/>
						  <a style="cursor:pointer;" class="tablinks" onclick="openCity(event, 'Tokyo')"> <i class="fa fa-deviantart" aria-hidden="true"></i> Talent</a><br/><br/>
						   <a style="cursor:pointer;" class="tablinks" onclick="openCity(event, 'Paris1')"> <i class="fa fa-th-large" aria-hidden="true"></i> Extras</a><br/><br/>
						  <a style="cursor:pointer;" class="tablinks" onclick="openCity(event, 'Tokyo-1')"><i class="fa fa-user" aria-hidden="true"></i> Custom </a>
						</div>
					...
					<h4>My Contacts</h4>
						<div class="panel panel-primary filterable">
							...
							<table class="span12">
								...
								<div class="bg tablescroll" style="height: 310px;">
										...
										<tr>
											<td style="width: 4.1%; width:50px;">
												<div class="checkbox radio-margin">
													<label>
														<input type="checkbox" value="{{$contact->id}}" name="contact[]"  @foreach ($getAllOwnersByCallId as $owner) @if($owner->owner_id == $contact->id ) checked @endif @endforeach>
...
<div id="Tokyo-1" class="tabcontent" style="display: none;">
	...
	<div class="text-center new-contacts-btuon">  
	   ...
	   <!-- <button class="btn btn-primary pull-right" type="submit">Add recipients </button> -->
				...
				<div class="select-type-bx bottom-bx">
					...
					<!-- <a href="{{URL::to('/updateScheduleCallsheet')}}/{{Request::segment(2)}}/{{Request::segment(3)}}"> Next</a> -->
...
<form action="{{url::to('/newprojectcontact')}}" class="form-group-left" method="post">
