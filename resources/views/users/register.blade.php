...
<span style="font-size:30px;cursor:pointer" onclick="openNav()"><img src="{{ URL::asset('front-end/images/icon_nav.png')}}"></span>
	 ...
	 <div class="card_form_bx register_bx">
	  <div class="card card-container">
            <!-- <img class="profile-img-card" src="//lh3.googleusercontent.com/-6V8xOA6M7BA/AAAAAAAAAAI/AAAAAAAAAAA/rzlHcD0KYwo/photo.jpg?sz=120" alt="" /> -->
            <img id="profile-img" 
            <p id="profile-name" class="profile-name-card"></p>
            <form class="form-signin register-form" action="{{URL::to('store')}}" method="post">
                ...
                <span id="reauth-email" class="reauth-email"></span>
								...
								<div class="col-sm-12">
									<div class="form-group">
										<label class="" for="user_type">Are you a company/ user ?</label>
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<input class="form-control placeholder-no-fix" type="text" placeholder="" name="first_name" id="first_name" /> 
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<input class="form-control" type="text" placeholder="" name="last_name" id="last_name" /> 
									</div>
								</div>
								</div>
								...
								<div class="col-sm-12">
									<div class="form-group">
										<label class="" for="InputFirstName">Company Name</label>
										<input class="form-control placeholder-no-fix" type="text" placeholder="" name="company_name" id="company_name" /> 
										<input type="hidden" name="_token" value="{{ csrf_token() }}">
									</div>
								</div>								
								</div>
								...
								<div class="col-sm-12">
									<div class="form-group">
										<label class="" for="InputEmail">Enter Your Email</label>
                 ...
                 <div class="col-sm-12"><button class="btn btn-lg btn-primary btn-block login" type="submit">Sign Up</button></div>
            </form><!-- /form -->
			<div class="col-sm-12"><div class="forgot-password-box">
			<p><a href="{{URL::to('/')}}"> Login</a>Already have Account? </p>
