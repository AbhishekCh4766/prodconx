		...
		<div class="mid-page addCallsheet-main">
			<div class="container">
				<div class="profile-part">
					...
					<form class="addCallsheet-bx-form" action="{{ URL::to('/updateScheduleToCallsheet')}}" method="POST" name="add_project_form" >
					...
					@foreach($data as $schedule)
						<div class="wrapper row">
							<div class="form-group cols-sm-6">
								...
								<div class="cols-sm-10">
									<div class="input-group">
										...
										<input type="time" class="form-control timepicker" name="schedule_time[]" id="time"  placeholder="7:00am" value="{{$schedule->schedule_time}}"/>
									</div>
								</div>
							</div>
							...
							<div class="form-group cols-sm-6 rightside">
								...
								<div class="cols-sm-10">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="schedule_scene[]" id="schedule_scene" required=""  placeholder="Enter Scene" value="{{$schedule->schedule_scene}}" />
									</div>
								</div>
							</div>
							...
							<div class="form-group cols-sm-6">
								...
								<div class="cols-sm-10">
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-file-text" aria-hidden="true"></i></span>
										<input type="text" class="form-control" name="schedule_desc[]" id="schedule_desc" required="" placeholder="Enter Description" value="{{$schedule->schedule_scene}}" />
									</div>
								</div>
							</div>
							...
							<div class="form-group cols-sm-6 rightside">
								...
								<select class="form-control" name="schedule_dn[]">
								  <option <?php if($schedule->schedule_scene == '1'){echo 'selected';} ?> value="1">Day</option>
								  <option <?php if($schedule->schedule_scene == '2'){echo 'selected';} ?> value="2">Night</option>
								</select>
							</div>
							...
							<div class="form-group cols-sm-6">
								...
								<div class="cols-sm-10">
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-file-text" aria-hidden="true"></i></span>
										<input type="text" class="form-control" name="schedule_cast[]" id="schedule_cast"  placeholder="Enter Cast"  value="{{$schedule->schedule_cast}}"/>
									</div>
								</div>
							</div>
							...
							<div class="form-group cols-sm-6 rightside">
								...
								<div class="cols-sm-10">
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-file-text" aria-hidden="true"></i></span>
										<input type="text" class="form-control" name="schedule_location[]" id="schedule_location"  placeholder="Enter Location" value="{{$schedule->schedule_location}}" />
									</div>
								</div>
							</div>
						...
						<div class="col-md-12">
							...
							<div class="form-group cols-sm-10">
								<button type="button" class="btn btn-danger pull-right removeme">Remove All </button>
							</div>
						</div>
					@endforeach
		           <div class="row">
