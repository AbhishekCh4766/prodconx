								...
								<div class="col-lg-8 col-xs-8 col-sm-8 add-a-job-section jobs-common-class middle-section">
									<div class="row">
										...
										@endif											
												...
												<form class="form-horizontal register-form"  method="POST" action="{{URL::to('saveJob')}}" enctype="multipart/form-data" >
													{{ csrf_field() }}
													...
													<div class="form-group">
														...
														<div class="col-lg-8">
														  <input class="form-control" type="text" name="job_location" id="job_location">
														</div>
													</div> 													
													<!-- <div class="form-group">
													...
													<div class="form-group">
														...
														<div class="col-lg-8">
														  <textarea class="form-control" rows="8" id="comment" name="job_decription"></textarea>
														</div>
													</div>
													...
													<div class="form-group">
														<div class="col-lg-8 col-lg-offset-3">
															<div class="checkbox">
																<label>
																  <input type="checkbox" name="post_to_profile"> Post to Profile
																</label>
															</div>
														</div>
													</div>  
