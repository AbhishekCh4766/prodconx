								...
								<div class="row">
									<div class="right-side">
										...
										<div class="row personal-info" style="margin-top:2px;">
											<form class="form-horizontal skill-form" method="POST" action="{{URL::to('addSkills')}}">
											...
											@endif
											  <div class="form-group">
											    ...
											    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="" name="skill_name[]">
											  </div>
											  <div class="form-group">
											  	<label for="skill_desc">Enter Description</label>
											  	<textarea class="form-control" rows="3" name="skill_desc[]" id="skill_desc" placeholder="Enter Description"></textarea>
											  </div>
											  <div class="newrow"></div>
											  <div class="row addskills">
											  	<div class="col-md-12">
											  		<button type="button" class="btn btn-default pull-right addSkillBtn">Add More Skills</button>
											  	</div>
											  </div>
