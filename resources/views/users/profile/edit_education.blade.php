								...
								<div class="row">
									<div class="right-side">
										...
										<div class="row personal-info" style="margin-top:2px;">
											<form class="form-horizontal education-form" method="POST" action="{{URL::to('editEducation',$education->id )}}">
											...
											@endif
											  <div class="form-group">
											    ...
											    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Title" name="title" value="{{ $education->title }}">
											  </div>
											  <div class="form-group">
											    <label for="location">Location</label>
											    <input type="text" class="form-control" id="location" placeholder="Location" name="location" value="{{ $education->location }}">
											  </div>
											  <div class="form-group">
											    <label for="start_year">Start Year</label>
											    <input type="text" class="form-control date-own" id="start_year" placeholder="Start Year" name="start_year" value="{{ $education->start_year }}">
											  </div>
											  <div class="form-group">
											    <label for="end_year">End Year</label>
											    <input type="text" class="form-control date-own" id="end_year" placeholder="End Year" name="end_year" value="{{ $education->end_year }}">
											  </div>
