									...
									<div class="portlet-body">
										<div class="table-toolbar">
											<div class="row">
												<div class="col-md-6">
													<div class="btn-group">
														<a href="{{URL::to('addRoles') }}" ><button id="sample_editable_1_new" class="btn sbold green"> Add New
										...
										<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
											...
											<tbody>
											@foreach($departmentRoles as $department)
												<tr class="odd gradeX">
													<td>
														<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
													...
													<td>
														<div class="btn-group">
															...
															<ul class="dropdown-menu" role="menu">
																...
																<li>
																	<a href="editDepartmentRole/{{$department->id}}">
